...
## The Surrounding `Seed` Project Structure

This public repository (`cursor-project-boilerplate/`) does not exist in a vacuum. It is a `View` inside a parent `Seed` project that has the standard structure:
